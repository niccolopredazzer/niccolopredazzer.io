...
openAnim.fromTo('.hero .bg-2 ', { opacity: 0 }, { opacity: 1, duration: 1.25 }, '-=.2');
openAnim.to('.hero .bg-2 ', { opacity: 0 });
openAnim.fromTo('.hero .bg-4 ', { opacity: 0 }, { opacity: 1, duration: 1.25 }, '-=.2');
openAnim.to('.hero .bg-4 ', { opacity: 0 });
openAnim.fromTo('.hero .bg-5 ', { opacity: 0 }, { opacity: 1, duration: 1.25 }, '-=.2');
openAnim.to('.hero .bg-5 ', { opacity: 0 });
openAnim.fromTo('.hero .bg-6 ', { opacity: 0 }, { opacity: 1, duration: 1.25 }, '-=.2');
openAnim.to('.hero .bg-6 ', { opacity: 0 });
